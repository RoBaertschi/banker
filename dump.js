...
db.Accounts.insertOne({
  ...
  transactions: [
    ...
    },
    {
      ...
      description:
        "invoice confirmed at Koelpin - Wunsch for TOP 464.22, card ending in ****6251 associated with account ***2752.",
    },
  ],
  number: 856169,
...
db.Accounts.insertOne({
  ...
  transactions: [
    ...
    },
    {
      ...
      description:
        "Payment of NPR 514.48 for invoice at Mann - Kirlin, processed with card ending ****9534 linked to account ***8467.",
    },
  ],
  number: 379104,
  ...
  transactions: [
    {
      ...
      description:
        "Your deposit of TWD 853.31 at Strosin, Frami and Wolf was successful. Charged via card ****8629 to account ***3501.",
    },
  ],
  number: 984369,
  description:
    "Decimus summisse absorbeo carcer decerno ipsam sequi voluptate.",
  balance: {
...
db.Accounts.insertOne({
  ...
  transactions: [
    ...
    },
    {
      ...
      description:
        "withdrawal confirmed at Hahn and Sons for RSD 980.45, card ending in ****5296 associated with account ***2999.",
    },
  ],
  number: 293239,
...
db.Accounts.insertOne({
  ...
  transactions: [
    ...
    },
    {
      ...
      description:
        "withdrawal processed at Balistreri, Kuhic and Fritsch for JPY 535.49, using card ending ****8664. Account: ***7355.",
    },
  ],
  number: 455331,
...
db.Accounts.insertOne({
  ...
  transactions: [
    ...
    },
    {
      ...
      description:
        "Payment of AED 561.19 for invoice at Wolf - Deckow, processed with card ending ****0533 linked to account ***9600.",
    },
  ],
  number: 461342,
...
db.Accounts.insertOne({
  ...
  transactions: [
    ...
    },
    {
      ...
      description:
        "invoice at Stanton and Sons with a card ending in ****5058 for RWF 850.68 from account ***2183.",
    },
  ],
  number: 812302,
...
db.Accounts.insertOne({
  ...
  transactions: [
    ...
    },
    {
      ...
      description:
        "A payment for MGA 119.75 was made at Mitchell, Quitzon and Waelchi via card ending ****1180 on account ***1406.",
    },
  ],
  number: 886317,
  description:
    "Averto tibi desparatus pariatur a subnecto aedificium conitor cunctatio defluo.",
  balance: {
...
db.Accounts.insertOne({
  ...
  transactions: [
    ...
    },
    {
      ...
      description:
        "Your invoice of IRR 493.23 at Bins, Hintz and Ernser was successful. Charged via card ****1083 to account ***0696.",
    },
  ],
  number: 951508,
...
db.Accounts.insertOne({
  ...
  transactions: [
    ...
    },
    {
      ...
      description:
        "Your payment of RWF 6.53 at Koelpin - Yost was successful. Charged via card ****7894 to account ***2724.",
    },
  ],
  number: 366839,
...
db.Accounts.insertOne({
  ...
  transactions: [
    ...
    },
    {
      ...
      description:
        "payment transaction at Walter and Sons using card ending with ****1551 for CLP 21.44 in account ***8618.",
    },
  ],
  number: 629970,
  ...
  transactions: [
    {
      ...
      description:
        "deposit at Ziemann, Mueller and Wyman with a card ending in ****7123 for SHP 960.58 from account ***9071.",
    },
  ],
  number: 310767,
  ...
  transactions: [
    {
      ...
      description:
        "deposit processed at Mayert Inc for STN 878.83, using card ending ****8753. Account: ***5525.",
    },
  ],
  number: 442635,
...
db.Accounts.insertOne({
  ...
  transactions: [
    ...
    },
    {
      ...
      description:
        "Payment of ZAR 808.19 for invoice at Medhurst, Waelchi and Robel, processed with card ending ****1822 linked to account ***6306.",
    },
  ],
  number: 835526,
  description:
    "Basium tamdiu auctus causa crudelis virtus tempora adhuc dignissimos.",
  balance: {
...
db.Accounts.insertOne({
  ...
  transactions: [
    ...
    },
    {
      ...
      description:
        "Payment of GHS 183.97 for invoice at Lang - Hermiston, processed with card ending ****7006 linked to account ***6220.",
    },
  ],
  number: 932119,
  description:
    "Decipio ubi tubineus acceptus ambulo cattus adinventitias aurum textilis.",
  balance: {
...
db.Accounts.insertOne({
  ...
  transactions: [
    ...
    },
    {
      ...
      description:
        "Transaction alert: deposit at Johnson, Bayer and Ullrich using card ending ****5273 for an amount of VES 479.73 on account ***9441.",
    },
  ],
  number: 849876,
...
db.Accounts.insertOne({
  ...
  transactions: [
    ...
    },
    {
      ...
      description:
        "A withdrawal for PEN 841.60 was made at Goyette - Torphy via card ending ****0550 on account ***7618.",
    },
  ],
  number: 754655,
...
db.Accounts.insertOne({
  ...
  transactions: [
    ...
    },
    {
      ...
      description:
        "withdrawal of MYR 624.13 at Emard and Sons charged to account ending in 4225 using card ending in ****6222.",
    },
  ],
  number: 694924,
...
db.Accounts.insertOne({
  ...
  transactions: [
    ...
    },
    {
      ...
      description:
        "payment confirmed at Balistreri - Rau for LYD 156.40, card ending in ****6846 associated with account ***5244.",
    },
  ],
  number: 831666,
...
db.Accounts.insertOne({
  ...
  transactions: [
    ...
    },
    {
      ...
      description:
        "deposit at Hyatt - Quitzon with a card ending in ****9912 for GYD 181.12 from account ***8445.",
    },
  ],
  number: 502646,
  description:
    "Tenuis alter contego thesis tutis aperiam virga somniculosus tricesimus adnuo.",
  balance: {
